...
switch (flagMode) do {
		...
		case 2: {
			["flag", "Flag_DNR_F"] call _fnc_saveToTemplate;
		...
		case 3: {
			["flag", "Flag_LNR_F"] call _fnc_saveToTemplate;
		...
		case 4: {
		    ["flag", "Flag_RUS_F"] call _fnc_saveToTemplate;
			flagX setFlagTexture "\RUS_markers_flags\flag_rus_co.paa";
			["flagTexture", "\RUS_markers_flags\flag_rus_co.paa"] call _fnc_saveToTemplate;

			MyInsignia = "shvr_rus";
			publicVariable "MyInsignia";
			["flagMarkerType", "flag_RUS"] call _fnc_saveToTemplate;
		};
		case 5: {
...
["vehicleBasic", "cwr3_o_uaz452"] call _fnc_saveToTemplate; 			
["vehicleLightUnarmed", "CUP_O_BMP3_RU"] call _fnc_saveToTemplate; 		
["vehicleLightArmed", "CUP_O_BTR60_Green_RU"] call _fnc_saveToTemplate; 		
["vehicleTruck", "CUP_O_Kamaz_Open_RU"] call _fnc_saveToTemplate; 			
["vehicleAT", "CUP_I_Hilux_SPG9_IND_G_F"] call _fnc_saveToTemplate; 		
["vehicleAA", "CUP_O_2S6M_RU"] call _fnc_saveToTemplate; 		

["vehicleBoat", "I_C_Boat_Transport_02_F"] call _fnc_saveToTemplate; 	
["vehicleRepair", "cwr3_o_ural_repair"] call _fnc_saveToTemplate; 			
["vehicleFuel", "CUP_O_Ural_Refuel_RU"] call _fnc_saveToTemplate; 			

["vehiclePlane", "CUP_O_SU34_RU"] call _fnc_saveToTemplate; 		
["vehiclePayloadPlane", "CUP_O_Su25_Dyn_RU"] call _fnc_saveToTemplate;
["vehicleHeli", "not_supported"] call _fnc_saveToTemplate; 		

["vehicleCivCar", "cwr3_c_uaz452"] call _fnc_saveToTemplate;
...
["vehicleCivSupply", "cwr3_c_ural_empty"] call _fnc_saveToTemplate;

["staticMG", "CUP_O_KORD_high_RU"] call _fnc_saveToTemplate; 					
["staticAT", "CUP_O_Kornet_RU"] call _fnc_saveToTemplate; 					
["staticAA", "CUP_O_Igla_AA_pod_RU"] call _fnc_saveToTemplate; 					
["staticMortar", "CUP_O_D30_ChDKZ"] call _fnc_saveToTemplate; 				
["staticMortarMagHE", "CUP_30Rnd_122mmHE_D30_M"] call _fnc_saveToTemplate;
["staticMortarMagSmoke", "CUP_30Rnd_122mmSMOKE_D30_M"] call _fnc_saveToTemplate;
...
["mineAPERS", ["ClaymoreDirectionalMine_Remote_Mag","APERSTripMine_Wire_Mag","APERSMine_Range_Mag"]] call _fnc_saveToTemplate;					
...
private _initialRebelEquipment = [
	...
	"CUP_srifle_Remington700", "CUP_sgun_Saiga12K", "CUP_srifle_CZ550_rail",
	"CUP_launch_RPG7V",
	"CUP_optic_PGO7V3",
	"CUP_PG7V_M",
	"CUP_PG7VR_M",
	...
	"CUP_V_RUS_6B3_2",
	"CUP_V_RUS_6B3_3",
	"CUP_Vest_RUS_6B45_Sh117_PKP_Green",
	"CUP_Vest_RUS_6B45_Sh117_VOG_Green",
	...
	"CUP_B_CivPack_WDL","CUP_B_ACRScout_m95",
	...
	"IEDLandSmall_Remote_Mag","IEDUrbanSmall_Remote_Mag","CUP_IED_V3_M","CUP_IED_V1_M","CUP_IED_V4_M","CUP_IED_V2_M",
	"CUP_PipeBomb_M","CUP_TimeBomb_M","APERSTripMine_Wire_Mag","APERSMine_Range_Mag", "ClaymoreDirectionalMine_Remote_Mag", "ATMine_Range_Mag","SLAMDirectionalMine_Wire_Mag"
];
...
shop_heli = ["CUP_I_Ka60_Blk_ION", "CUP_I_412_Military_Armed_PMC", "CUP_B_AW159_HIL"];
...
_loadoutData setVariable ["uniforms", [
   /* "eou_gorka_17",  //платный контент ГОРКА
	"eou_gorka_9",
	"eou_gorka_25",
	"eou_gorka_31",
	"eou_gorka_32",
