...
if (gamemode == 4) then {
	["noGamemode",false,1,false,false] call BIS_fnc_endMission;
};

if ((gameMode != 1) && (gameMode != 5)) then {			// probably shouldn't be here...
...
if (gameMode == 5) then {			// probably shouldn't be here...
