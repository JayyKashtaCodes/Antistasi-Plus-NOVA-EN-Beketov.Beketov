...
flagX addAction [localize "STR_FLAGMODE_SELECT", {
			//_ComMenu_1 = [player,"myFlag_CommunicationMenu"] call BIS_fnc_addCommMenuItem;
			showCommandingMenu '#USER:MENU_COMMS_1';  // if you wanted to show your custom menu on a keydown event or something
							 },nil,0,false,true,"","(_this == theBoss)",4];	
flagX addAction [localize "STR_SIGMODE_SELECT", {
			//_ComMenu_2 = [player,"myZnak_CommunicationMenu"] call BIS_fnc_addCommMenuItem;
			showCommandingMenu '#USER:MENU_COMMS_2';  // if you wanted to show your custom menu on a keydown event or something
							 },nil,0,false,true,"","(_this == theBoss)",4];		
...
[petros, ""] call BIS_fnc_setUnitInsignia;
[petros, MyInsignia] call BIS_fnc_setUnitInsignia;
[petros, "Male01RUS"] remoteExec ["setSpeaker", 0, true];
...
//Set Voice
[player, "Male01RUS"] remoteExec ["setSpeaker", 0, true];
//Set Insignia
[player, ""] call BIS_fnc_setUnitInsignia;
[player, MyInsignia] call BIS_fnc_setUnitInsignia;
