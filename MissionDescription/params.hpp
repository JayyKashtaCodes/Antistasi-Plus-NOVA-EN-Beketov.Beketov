...
class Params
{
	...
	class flagMode
    {
        title = "Choosing your flag";
        values[] = {1,2,3,4,5};
        texts[] = {"Novorossia","DNR","LNR","RUS","USSR"};
        default = 1;
    };
    class gameMode
    {
        ...
        texts[] = {"Load From Save (Default - Reb & Inv vs Gov)","Reb vs Gov vs Inv","Reb vs Gov & Inv","Reb vs Gov", "-----------", "Reb & Inv vs Gov"};
        default = 5;
    };
    class autoSave
    {
